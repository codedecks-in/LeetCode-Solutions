...
| 204  | [Count Primes](https://leetcode.com/problems/count-primes)                            | [C++](./C++/Count-Primes.cpp) <br> [JavaScript](./JavaScript/204.Count-Primes.js) | _O(n(log(logn)))_ | _O(n)_ | Easy       | Math   |               |
