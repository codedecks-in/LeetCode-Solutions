...
| 387  | [First Unique Character in a String](https://leetcode.com/problems/first-unique-character-in-a-string/)                                         | [Java](./Java/first-unique-character-in-a-string.java) <br> [Python](./Python/387.FirstUnique.py)                     | _O(n)_ | _O(1)_ | Easy       |     | Character Count |
