...
| 378 | [Kth smallest element in sorted matrix](https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix/))                             | [Python](./Python/kth-smallest-element-in-a-sorted-matrix.py)                                                                             | _O(n)_ | _O(1)_ | Medium       |     | Binary Search |
