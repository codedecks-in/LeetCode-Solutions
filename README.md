...
| 139 | [Copy List with Random Pointer](https://leetcode.com/problems/copy-list-with-random-pointer/) | [Java](./Java/copy-list-with-random-pointer.java)                       | _O(n^2)_     | _O(n)_ | Medium     | LinkedList         |                                          |
