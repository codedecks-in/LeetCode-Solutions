...
| 3    | [Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters/) | [Java](./Java/Longest-Substring-Without-Repeating-Characters.java) | _O(n)_ | _O(min(m,n))_ | Medium | `Hash Table`<br/>`Sliding Window` |
