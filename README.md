...
| 93  | [Reverse IP Address](https://leetcode.com/problems/restore-ip-addresses/)   | [C++](./C++/restore-ip-addresses.cpp)  | _O(n)_                  | _O(n)_      | Medium     | String, Backtracking |      |
<br/>
<div align="right">
    <b><a href="#algorithms">⬆️ Back to Top</a></b>
</div>
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Muhammad Saad Siddique](https://github.com/MuhammadSaadSiddique) <br> <img src="https://github.com/MuhammadSaadSiddique.png" width="100" height="100">                                                                     | Pakistan          | Python, Kotlin                 |  [LeetCode](https://leetcode.com/muhammaadsaad/)                                                               |
