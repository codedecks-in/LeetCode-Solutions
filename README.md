...
| 450 | [Delete Node in a BST](https://leetcode.com/problems/delete-node-in-a-bst/description/)   |[C++](./C++/450.Delete-Node-in-a-BST.cpp)| _O(n)_      | _O(n)_      | Medium     | Binary Tree, Binary Search Tree                                    |      |
