...
| 83 | [Remove Duplicates from Sorted List](https://leetcode.com/problems/remove-duplicates-from-sorted-list/)   | [C++](./C++/delete_duplicates.cpp)                                            | _O(n)_     | _O(1)_ | Easy       | Two pointers       |
